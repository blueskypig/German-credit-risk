...
%% classification
disp('Discriminant analysis(Quadratic)')
...
for tindex=1:foldnum
    ...
    for T=1:ctimes
        ...
        for fnum=1:size(features,2)
            ...
            for i=1:foldnum 
                ...
                %% classifier
                mdllinear=fitcdiscr(trfeatures,trlabels,'Cost',costM,'DiscrimType','pseudoquadratic');
                pred_labels=predict(mdllinear,vfeatures);
                %% evaluation
    ...
    %% classifier
     mdllinear=fitcdiscr(traindata,trainlabels,'Cost',costM,'DiscrimType','pseudoquadratic');
     pred_labels=predict(mdllinear,testdata);
     %% evaluation
